// 应用分类（包名 → 学习/娱乐）
// ⚠️ 必须与 android_plugin/.../MonitorService.kt 里的包名完全一致
export const STUDY_PACKAGES = new Set([
...
export const ENTERTAINMENT_PACKAGES = new Set([
