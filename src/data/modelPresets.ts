// 国内主流大模型 API 预设（OpenAI 兼容协议，2025 年最新）
...
export const MODEL_PRESETS: ModelPreset[] = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'qwen-max', name: 'Qwen-Max', desc: '推理能力强，适合复杂任务' },
  ...
  },
  {
    ...
    featured: true,
    models: [
      { id: 'deepseek-chat', name: 'DeepSeek-V3', desc: '通用旗舰，对话首选', tags: ['推荐'] },
  ...
  },
  {
    ...
    featured: true,
    models: [
      { id: 'kimi-latest', name: 'Kimi K2 Latest', desc: '最新旗舰', tags: ['推荐', '新'] },
  ...
  },
  {
    ...
    accent: '#FF2E4D',
    models: [
      { id: 'doubao-1-5-pro-32k-250115', name: 'Doubao 1.5 Pro', desc: '最新 Pro 旗舰', tags: ['推荐'] },
      { id: 'doubao-pro-32k', name: 'Doubao Pro 32k', desc: '上一代 Pro' },
      { id: 'doubao-pro-4k', name: 'Doubao Pro 4k', desc: '4k 上下文' },
      { id: 'doubao-lite-32k', name: 'Doubao Lite 32k', desc: '轻量极速版' }
    ]
  },
  {
    id: 'ernie',
    ...
    accent: '#2932E1',
    models: [
      { id: 'ernie-4.0-8k-latest', name: 'ERNIE 4.0', desc: '4.0 旗舰 8k', tags: ['推荐'] },
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'abab6.5-chat', name: 'abab6.5', desc: '6.5 旗舰', tags: ['推荐'] }
    ]
  },
  {
    id: 'hunyuan',
